...
public class CajeraProductoThread extends Thread {
    ...
    public CajeraProductoThread(String nombreCajera, ClienteProducto clienteproducto, long itinialtime) {
        this.nombreCajera = nombreCajera;
        this.clienteproducto = clienteproducto;
        this.initialTime = itinialtime;
    }

    @Override
    public void run() {
        procesarCompra(clienteproducto, initialTime);
    }
